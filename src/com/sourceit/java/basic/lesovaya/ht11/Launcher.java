...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		System.out.println("How often the character occurs in a text: " +  text.getCharFrequency('o'));
		System.out.println("The number of characters c: " + text.getCharCount('m'));
		...
		System.out.println("Char by count: " + text.getCharByCount(68));
