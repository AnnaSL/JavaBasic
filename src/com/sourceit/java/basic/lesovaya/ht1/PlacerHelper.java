package com.sourceit.java.basic.lesovaya.ht1;
...
public class PlacerHelper implements Serializable {
	...
	public ArrayList<String> checkNeighborCell(int n, int m){
